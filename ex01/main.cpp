...
cat.setBrainIdea("I'm a good cat, I'm gonna tell the truth to the dog.", 2);
...
dog2.setBrainIdea("I don't like being pet", 0);
dog2.getBrainIdea(0);
cat2.setBrainIdea("I don't like being pet", 0);
